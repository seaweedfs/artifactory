...
try:
 for name in ['testops-loopback-disk-full']:
  ...
  (folder/'execution.json').write_text(json.dumps({'exit':p.returncode,'product':'ac7f4e0f08716ecc0ed1b418b5f26fdfb752c34f','harness':'42dd1bb40de5ee8affebf799cbf86da64f54e2f5','scope':'product replication' if 'partition' in name else 'synthetic testops mechanism control'}))
